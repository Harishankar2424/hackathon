...
export const mockContracts = [
  ...
  },
  {
    ...
    vendorId: "ven_2",
    vendorName: "Innovate Solutions",
    title: "UK Distribution for 'ConnectSphere' Software",
    product: "ConnectSphere CRM",
    region: "Europe",
    status: "Open",
    details: `This is a non-exclusive distribution agreement for our new 'ConnectSphere' CRM software specifically for the United Kingdom market. We require a partner with a strong B2B sales network. Minimum sales target is 1,000 licenses per year. Payment terms are NET 30. The contract is for a 2-year term, with performance-based renewal.`,
     summary: {
      "Exclusive/Non-Exclusive Rights": "Non-Exclusive",
      "Territory & Sales Scope": "United Kingdom",
      "Pricing & Payment Terms": "NET 30",
      "Minimum Sales or Purchase Requirements": "1,000 licenses per year",
      "Intellectual Property & Brand Use": "Marketing materials provided, brand use approved",
      "Term, Renewal & Termination": "2-year term, performance renewal",
      "Confidentiality & Non-Compete": "Standard confidentiality required",
    },
  },
  {
    id: "cont_6",
    vendorId: "ven_3",
    vendorName: "Quantum Goods",
    title: "Latin America Agreement for 'AudioMax' Headphones",
    product: "AudioMax Headphones",
    region: "Latin America",
    status: "Open",
    details: `We are seeking an exclusive distributor for our new 'AudioMax' headphone line in Brazil, Mexico, and Argentina. Partner must have experience with consumer electronics. Minimum purchase of 5,000 units per quarter. Payment terms are NET 60. Three-year contract with an exclusivity review after the first year.`,
     summary: {
      "Exclusive/Non-Exclusive Rights": "Exclusive (with review)",
      "Territory & Sales Scope": "Brazil, Mexico, Argentina",
      "Pricing & Payment Terms": "NET 60",
      "Minimum Sales or Purchase Requirements": "5,000 units per quarter",
      "Intellectual Property & Brand Use": "Co-marketing budget available",
      "Term, Renewal & Termination": "3-year term, with 1-year review",
      "Confidentiality & Non-Compete": "Non-compete for high-end audio products",
    },
  },
];
